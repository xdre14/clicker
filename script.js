...
// Функція, яка буде викликатися при кліку на кнопку
...
// Update score, start timer, and play sound
function handleClick() {
  score++;
...
function endGame() {
  ...
  scoreEl.textContent = score;
  timeEl.textContent = formatTime(time);
  clickButton.style.backgroundColor = "#ff9900"; // повертаємо колір кнопки на початкове значення
}
